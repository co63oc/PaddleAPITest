...
c_file="report/0size_tensor_gpu/error_config.txt"
c_file="report/0size_tensor_cpu/error_config.txt"
echo "accuracy"
...
python engine.py --accuracy=True --test_cpu=True --api_config_file=$c_file --filter "$1"
