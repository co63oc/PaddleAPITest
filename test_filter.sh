...
echo "accuracy"
python engine.py --accuracy=True --api_config_file=report/0size_tensor_gpu/20250528/accuracy/error_config.txt --filter "$1"
echo "paddleonly"
python engine.py --paddle_only=True --api_config_file=report/0size_tensor_gpu/20250528/paddleonly/error_config.txt --filter "$1"
